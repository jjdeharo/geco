const TRANSLATIONS = {
  es: {
    ...
    duplicateNames: 'Nombres repetidos: {names}. Cada persona debe aparecer una sola vez; se usará su última aparición. Si son personas distintas, añade una inicial para distinguirlas.',
  ...
  ca: {
    ...
    duplicateNames: 'Noms repetits: {names}. Cada persona ha d\'aparèixer una sola vegada; es farà servir la darrera aparició. Si són persones diferents, afegeix una inicial per distingir-les.',
  ...
  en: {
    ...
    duplicateNames: 'Repeated names: {names}. Each person must appear only once; the last occurrence will be used. If they are different people, add an initial to tell them apart.',
  ...
  gl: {
    ...
    duplicateNames: 'Nomes repetidos: {names}. Cada persoa debe aparecer unha soa vez; usarase a súa última aparición. Se son persoas distintas, engade unha inicial para distinguilas.',
    infoGroups: 'Equipos: {teams} | Sobran: {leftovers}',
  ...
  eu: {
    ...
    duplicateNames: 'Izen errepikatuak: {names}. Pertsona bakoitzak behin bakarrik agertu behar du; azken agerpena erabiliko da. Pertsona desberdinak badira, gehitu inizial bat bereizteko.',
