...
- **Windows (instalador con asistente)** → [GeCo-Setup-2.5.0.exe](https://github.com/jjdeharo/geco/releases/download/v2.5.0/GeCo-Setup-2.5.0.exe): instala la aplicación en `C:\Archivos de programa\GeCo`, crea accesos directos y gestiona actualizaciones.
- **Windows (portable)** → [GeCo-2.5.0.exe](https://github.com/jjdeharo/geco/releases/download/v2.5.0/GeCo-2.5.0.exe): ejecutable auto-contenido para llevar en un USB sin instalación.
- **macOS (Intel y Apple Silicon)** → [GeCo-2.5.0.dmg](https://github.com/jjdeharo/geco/releases/download/v2.5.0/GeCo-2.5.0.dmg): imagen universal, arrástrala a `Aplicaciones`.
- **macOS (Apple Silicon optimizado)** → [GeCo-2.5.0-arm64.dmg](https://github.com/jjdeharo/geco/releases/download/v2.5.0/GeCo-2.5.0-arm64.dmg): mismo contenido, compilado específicamente para chips M1/M2.
- **Linux (AppImage)** → [GeCo-2.5.0.AppImage](https://github.com/jjdeharo/geco/releases/download/v2.5.0/GeCo-2.5.0.AppImage): binario portable, marca el archivo como ejecutable y lánzalo sin instalar.
- **Linux (paquete DEB)** → [geco_2.5.0_amd64.deb](https://github.com/jjdeharo/geco/releases/download/v2.5.0/geco_2.5.0_amd64.deb): instalador para Debian, Ubuntu y derivadas de 64 bits.
